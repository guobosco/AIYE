...
class UserBase(BaseModel):
    ...
    favorite_experience_ids: List[str] = Field(default_factory=list)
    signature: str = ""
    memo: str = ""
    gender: str = ""
    region: str = ""
...
class FavoriteExperiencesUpdateRequest(BaseModel):
    experience_ids: List[str] = Field(default_factory=list)


class FavoriteExperiencesResponse(BaseModel):
    experience_ids: List[str] = Field(default_factory=list)
...
class ExperienceBase(BaseModel):
    ...
    @field_validator("image_urls", "tags", "detail_steps", mode="before")
    @classmethod
