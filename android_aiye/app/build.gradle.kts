...
android {
    ...
    defaultConfig {
        ...
        val wechatUniversalLink = providers.gradleProperty("WECHAT_UNIVERSAL_LINK").orElse("").get()
        buildConfigField("String", "WECHAT_APP_ID", "\"$wechatAppId\"")
        buildConfigField("String", "WECHAT_UNIVERSAL_LINK", "\"$wechatUniversalLink\"")
        manifestPlaceholders["WECHAT_APP_SCHEME"] =
            providers.gradleProperty("WECHAT_APP_SCHEME")
                .orElse(if (wechatAppId.isBlank()) "wx0000000000000000" else "wx$wechatAppId")
                .get()
    }
