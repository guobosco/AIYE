...
fun AppNavHost(intentState: Intent? = null) {
    ...
    NavHost(
        ...
        composable(Screen.MyBookedServices.route) {
            MyBookedServicesScreen(navController = navController)
        }
        composable(Screen.MyViewedServices.route) {
            MyViewedServicesScreen(navController = navController)
        }
        composable(
...
sealed class Screen(val route: String) {
    ...
    object MyBookedServices : Screen("my_booked_services")
    object MyViewedServices : Screen("my_viewed_services")
